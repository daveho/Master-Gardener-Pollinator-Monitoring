    ...
    <header class="item header margin-top-0 header10" id="header10">
        ...
        <div class="wrapper">
            ...
            <div>
                    ...
                    <form id="GroupGet" method="post">
                        <table id="userGroups">
                            <c:forEach items="${groups}" var="group">
                                <tr class="groupList">
                                    <td style="color:white"><input type="submit" value="${group.name}" id="groupDisplay"
                ...
                <div class="sidebar">
                    <button onclick="toggleSideBar()" id="toggle" style="right: 0px;color: white">Garden Options
                    </button>
